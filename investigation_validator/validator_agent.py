...
# Base directory for Claude invocation. Overridable via INVESTIGATION_VALIDATOR_BASE;
# defaults to the package's own directory so invocations resolve locally rather than
# against the legacy mini-mind-v2 path.
import os as _os
BASE_DIR = _os.environ.get(
    "INVESTIGATION_VALIDATOR_BASE",
